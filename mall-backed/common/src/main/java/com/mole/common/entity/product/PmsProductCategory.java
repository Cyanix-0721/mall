...
public class PmsProductCategory implements Serializable {
    ...
    @Schema(description = "上级分类编号：0表示一级分类", example = "0")
    ...
    @Schema(description = "是否显示在导航栏：0->不显示；1->显示", allowableValues = {"0", "1"}, defaultValue = "1")
    private Integer navStatus;

    @Schema(description = "显示状态：0->不显示；1->显示", allowableValues = {"0", "1"}, defaultValue = "1")
